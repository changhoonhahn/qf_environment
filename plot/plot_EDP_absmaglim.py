...
target_sdss     = fits.open(targetdir+'target_cylr1h50_thresh80_nbin2_all_sdss_lit.fits')
target_primus   = fits.open(targetdir+'target_cylr1h50_thresh80_nbin6_all_lit.fits') 
